...
## Formatting
- 80 characters is a hard line-length limit for code and code comments — wrap rather than exceed it. Exceptions: unbreakable tokens (long URLs, generated strings), and any line-length convention set by a project's own CLAUDE.md, which overrides this.
